...
public class DickExercise
{
    public static async Task TryExercise(long user_id, long group_id, int exerciseTimes = 1)
    {
        ...
        [
            ...
            "在锻炼过程当中，希儿出现在你的面前。她好奇地摸了摸你的牛子，柔软的触感使你的牛子", "在锻炼完毕以后，诺艾尔出现在你面前。她拿出她的石锤，为你的牛子进行了一次特制的石锤按摩，你的牛子在按摩过程中",
            "在锻炼的过程当中，银狼发现了你的牛子，她使用黑客技术为你的牛子进行了以太编码，这使得你的牛子"
        ];
        string[] loseString =
        [
            "过度锻炼使你的牛子受到损伤", "在锻炼完毕以后，希儿不小心咬伤了你的牛子。疼痛使你的牛子瞬间", "在锻炼当中，你遇到了莫娜。她误以为你的牛子是一种妖怪，用魔法攻击了它，这使得你的牛子",
