...
public class 文案生成器
{
    public static string WinWhenFight(long challengerId, string challengerNickName, long enemyId, string enemyNickName)
    {
        ...
        [
            ...
            $"[CQ:at,qq={challengerId},你的牛子[{challengerNickName}]如闪电一般，迅猛出击，令{enemyId}的牛子[{enemyNickName}]措手不及，最终赢得了比赛！这是一场毫无悬念的胜利！",
            $"[CQ:at,qq={challengerId},在一阵风的助力下，你的牛子[{challengerNickName}]突然间加速，猛然撞击{enemyId}的牛子[{enemyNickName}]，取得了意外的胜利！"
        ];
